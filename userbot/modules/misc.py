...
async def killdabot(event):
    ...
    await event.edit("`Menonaktifkan KYURA-UBOT....`")
    await asyncio.sleep(7)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#SHUTDOWN \n"
                                        "`KYURA-UBOT Telah Dinonaktifkan`")
    await bot.disconnect()


@register(outgoing=True, pattern="^.restart$")
async def killdabot(event):
    await event.edit("`Restarting KYURA-UBOT...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#RESTARTBOT \n"
                                        "`KYURA-UBOT Telah Di Restart`")
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[KYURA-UBOT Repo](https://github.com/Kyuraxp/KYURA-UBOT/blob/RAM-UBOT/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        f"**╭✠╼━━━━━━❖━━━━━━━✠╮**\n             [{REPO_NAME}](https://github.com/Kyuraxp/KYURA-UBOT)\n╰✠╼━━━━━━❖━━━━━━━✠╯\n•PEMILIK         : [𝐎𝐖𝐍𝐄𝐑]({OWNER_BOT})\n•CHANNEL      : [𝐈𝐍𝐅𝐎](t.me/Kyuraprojects)\n•GROUP           : [𝐆𝐑𝐎𝐔𝐏](t.me/kyurasupport)\n•"
    )

    ...
    if HEROKU_API_KEY is not None:
        ...
        if HEROKU_APP_NAME is None:
            await event.edit(
                ...
                ' untuk dapat deploy perubahan terbaru dari KYURA-USERBOT.`'
            )
            repo.__del__()
            return
        ...
        if heroku_app is None:
            await event.edit(
                f'{txt}\n`Kredensial Heroku tidak valid untuk deploy KYURA-UBOT dyno.`'
            )
            return repo.__del__()
...
CMD_HELP.update({
    'update':
    ".update"
    "\nUsage: Untuk Melihat Pembaruan Terbaru KYURA-UBOT."
    "\n\n.update one"
    "\nUsage: Memperbarui KYURA-UBOT."
    "\n\n.update all"
    "\nUsage: Memperbarui KYURA-UBOT Dengan Cara Deploy Ulang."
})
